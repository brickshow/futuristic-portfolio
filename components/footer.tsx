...
function Facebook(props: any) {
  return (
    ...
    >
      ...
      <path d="M16 11h-2V9a1 1 0 0 1 1-1h1V5h-2a3 3 0 0 0-3 3v3H8v3h2v7h3v-7h2l1-3z" />
    </svg>
  )
}
    ...
    >
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex justify-center space-x-6 mt-4">
          <SocialLink icon={<Github className="h-5 w-5" />} href="https://github.com/brickshow" />
          <SocialLink icon={<Linkedin className="h-5 w-5" />} href="https://www.linkedin.com/in/brix-lampago-183293322/" />
          <SocialLink icon={<Twitter className="h-5 w-5" />} href="https://x.com/LampagoBri97258?t=pyRdg4G414nBLQPYQZIT_g&s=09" />
          <SocialLink icon={<Instagram className="h-5 w-5" />} href="https://www.instagram.com/brcksyow?igsh=bGhvZWJpODNud2ti" />
